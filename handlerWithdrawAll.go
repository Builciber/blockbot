...
func (cfg *apiConfig) handlerWithdrawAll(ctx context.Context, b *bot.Bot, update *models.Update) {
	...
	cfg.intSeqMap[chatID(update.CallbackQuery.Message.Message.Chat.ID)] = &interactionSequence{
		funcSlice:   []interactionHandler{cfg.handlerWithdrawAllProcessAddress},
